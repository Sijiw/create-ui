...
export const useNamespace = (componentName: string) => {
  ...
  // 返回一个`y--${componentName}-${block}__${element}`字符串
  const addBE = (
    block: string | undefined,
  ...
  // 返回一个`y--${componentName}__${element}--${modifier}`字符串
  const addEM = (
    element: string | undefined,
    modifier: string | undefined
  ): string => {
  ...
  // 返回一个`y--${componentName}-${block}__${element}--${modifier}`字符串
  const addBEM = (
    block: string | undefined,
    element: string | undefined,
    modifier: string | undefined
